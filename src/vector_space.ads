...
package Vector_Space is
   ...
   type Index_Type is new Natural range 1..3;

   type Vector_Type is array(Index_Type) of Value_Type;
   ...
   function Vector( X,Y,Z : in Value_Type ) return Vector_Type ;

   function Component( X : in Vector_type; I : in Index_Type ) return Value_Type;
